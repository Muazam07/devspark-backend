...
const EmailVerificationTemplate = (user, code, options = {}) => {
  ...
  const content = `
    ...
    <p style="margin: 0; color: #1c398e; font-family: 'Inter', 'Avenir Next', 'Helvetica Neue', 'Segoe UI', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 23px; text-align: center;">
